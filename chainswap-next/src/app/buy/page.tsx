...
export default function BuyPage() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      <Navbar />
      <main className="max-w-6xl mx-auto px-4 py-8 w-full" data-testid="buy-page">
        <h1 className="font-sans text-3xl font-bold text-foreground mb-2">
          Buy USDT
        </h1>
        <p className="text-muted-foreground mb-6">
          Find sellers and buy USDT with your preferred payment method
        </p>
              ...
              >
                <div className="flex flex-wrap items-center justify-between gap-4">
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        ...
                        {offer.user_stats?.is_verified_trader && (
                          <span className="inline-flex items-center gap-0.5 px-1.5 py-0.5 bg-primary/10 text-brand rounded-full text-[10px] font-semibold">
                  ...
                  <div className="text-right">
                    <p className="text-2xl font-bold text-brand font-sans">
                      &#8377;{offer.price_inr}
                    </p>
          ...
          <div className="bg-card rounded-2xl p-6 w-full max-w-md border border-border">
            <div className="flex items-center justify-between mb-6">
              <h3 className="font-sans text-xl font-bold text-foreground">
                Buy USDT from {selectedOffer.username}
              </h3>
              <button
